...
export const pipelineStages: CrmPipelineStage[] = [
  { id: 'ps-sem-contato', name: 'Sem Contato', position: 0, color: 'bg-slate-100 text-slate-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-aguardando-resposta', name: 'Aguardando Resposta', position: 1, color: 'bg-sky-100 text-sky-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-em-conversa', name: 'Em Conversa', position: 2, color: 'bg-cyan-100 text-cyan-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-qualificacao', name: 'Qualificação', position: 3, color: 'bg-blue-100 text-blue-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-proposta-enviada', name: 'Proposta Enviada', position: 4, color: 'bg-purple-100 text-purple-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-negociacao', name: 'Negociação', position: 5, color: 'bg-amber-100 text-amber-800', is_won: false, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-fechado-ganho', name: 'Fechado Ganho', position: 6, color: 'bg-green-100 text-green-800', is_won: true, is_lost: false, funnel_id: null, created_at: daysAgo(90) },
  { id: 'ps-fechado-perdido', name: 'Fechado Perdido', position: 7, color: 'bg-red-100 text-red-800', is_won: false, is_lost: true, funnel_id: null, created_at: daysAgo(90) },
]
...
export const deals: CrmDeal[] = [
  {
    id: 'd1', title: '200 Clássicos - TechCorp', stage_id: 'ps-negociacao', funnel_id: null, company_id: 'co1', contact_id: 'ct1',
    ...
    priority: 'high', position: 0, budget_range: null, urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(30), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(3),
    won_at: null, lost_at: null, created_by: 'u1', created_at: daysAgo(30), updated_at: daysAgo(3),
  },
  {
    id: 'd2', title: '500 Lite Plus - Serra Gaúcha', stage_id: 'ps-proposta-enviada', funnel_id: null, company_id: 'co2', contact_id: 'ct3',
    ...
    priority: 'urgent', position: 0, budget_range: null, urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(20), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(5),
    won_at: null, lost_at: null, created_by: 'u1', created_at: daysAgo(20), updated_at: daysAgo(5),
  },
  {
    id: 'd3', title: '100 Lite - Banco Investir', stage_id: 'ps-qualificacao', funnel_id: null, company_id: 'co3', contact_id: 'ct4',
    ...
    priority: 'medium', position: 0, budget_range: null, urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(15), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(7),
    won_at: null, lost_at: null, created_by: 'u2', created_at: daysAgo(15), updated_at: daysAgo(7),
  },
  {
    id: 'd4', title: '50 Clássicos - Criativa', stage_id: 'ps-sem-contato', funnel_id: null, company_id: 'co4', contact_id: 'ct5',
    ...
    priority: 'low', position: 0, budget_range: 'R$150-200', urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(2), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(2),
    won_at: null, lost_at: null, created_by: 'u2', created_at: daysAgo(2), updated_at: daysAgo(2),
  },
  {
    id: 'd5', title: '300 Lite - Bella Vista', stage_id: 'ps-sem-contato', funnel_id: null, company_id: 'co5', contact_id: 'ct6',
    ...
    priority: 'medium', position: 1, budget_range: 'R$80-100', urgency: 'Abril 2026', tags: [], estimated_value: null,
    first_interaction_at: daysAgo(1), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(1),
    won_at: null, lost_at: null, created_by: 'u1', created_at: daysAgo(1), updated_at: daysAgo(1),
  },
  {
    id: 'd6', title: '150 Clássicos - TechCorp (2a compra)', stage_id: 'ps-fechado-ganho', funnel_id: null, company_id: 'co1', contact_id: 'ct1',
    ...
    priority: 'high', position: 0, budget_range: null, urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(75), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(40),
    won_at: daysAgo(40), lost_at: null, created_by: 'u1', created_at: daysAgo(75), updated_at: daysAgo(40),
  },
  {
    id: 'd7', title: '80 Lite Plus - Empresa XYZ', stage_id: 'ps-fechado-perdido', funnel_id: null, company_id: null, contact_id: 'ct7',
    ...
    priority: 'low', position: 0, budget_range: null, urgency: null, tags: [], estimated_value: null,
    first_interaction_at: daysAgo(50), whatsapp_outreach_at: null, ai_disabled_at: null, stage_entered_at: daysAgo(10),
